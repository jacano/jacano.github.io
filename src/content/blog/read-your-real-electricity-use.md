...
The electricity bill shows one number per month. That number does not tell you *when* you use the energy. Without the hourly data you cannot compare tariffs with real numbers. You can only guess.
...
A retailer sells the same energy with different prices for P1, P2 and P3. Your bill depends on how much energy you use in each period. With your real split you can compare two retailers in one minute. You can also see if moving the washing machine or the car charge to P3 saves money.
...
The tool is unofficial. It is not connected to e-distribucion or Endesa. Use it only with your own account.
